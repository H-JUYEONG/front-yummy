        ...
        <section id="user-wrap-main">
          ...
          <div className="j-search-bar">
            <input
              ...
              className="j-search-input2"
            />
            <button className="j-search-button2" onClick={handleSearch}>
              <Search size={20} />
            </button>
          </div>
              ...
              {selectedStyle === "게시글" &&
                debateList.map((item) => (
                  ...
                  >
                    ...
                    <td className="user-write-title">{item.debate_title}</td>
                ...
                {selectedStyle === "댓글" &&
                  commentList.map((item) => (
                    ...
                    >
                      ...
                      <td className="user-write-title">{item.debate_comment_content.slice(0, 10)}...</td>
                  ...
                  {selectedStyle === "리뷰" &&
                    reviewList.map((item) => (
                      ...
                      >
                        <td>{item.reviewId}</td>
                        <td className="user-write-title">{item.productName}</td>
