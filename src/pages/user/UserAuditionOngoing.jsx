...
const UserAuditionOngoing = () => {
    ...
    const selectedCompany = {
        ...
        rating: 4,
        bidAmount: "39,000원",
        image: "/images/cake-example1.png",
    };
    ...
    const participatingCompanies = [
        ...
        },
        {
            ...
            rating: 5,
            bidAmount: "45,000원",
            image: "/images/cake-example2.png",
        },
    ];
    ...
    return (
        <div id="user-wrap" className="text-center ongoing-audition">
            ...
            <main id="user-wrap-body" className="clearfix ongoing-content">
                <div className="ongoing-back-button-container">
                    <button className="ongoing-back-button" onClick={() => navigate(-1)}>
                        {"< 뒤로가기"}
                    </button>
                </div>
                ...
                <div className="toggle-status-container">
                    <button onClick={() => setIsEnded(!isEnded)}>
                ...
                <div className="ongoing-main-content">
                    <div className="ongoing-auction-info">
                        ...
                        <div className="ongoing-design-preview">
                            <h3>예시도안</h3>
                            <img src="/images/example-design.png" alt="예시 도안" />
                            <p>아빠 생일 축하드립니다</p>
                        </div>
                    </div>
