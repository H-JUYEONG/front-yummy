                    ...
                    <section className="status-description">
                        ...
                        <table className="description-table">
                            <tbody>
                                ...
                                <tr>
                                    <td>픽업일(D-day)</td>
                                    <td>예약하신 시간에 맞게 제품 준비합니다.</td>
                                </tr>
                                <tr>
                                    <td>픽업완료</td>
                                    <td>고객에 픽업완료된 상태입니다.</td>
                                </tr>
                                <tr>
                                    <td>주문취소</td>
                                    <td>채널별로 진행되어 있는 주문취소건에 의해 주문취소가 완료되었습니다. (단, 취소글 별동)</td>
                                </tr>
                            </tbody>
                        </table>
                    </section>
