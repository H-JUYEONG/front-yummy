...
const UserMyPageCakeDesignList = () => {
  ...
  const loadCakeDesigns = (page = 1) => {
    switch (selectedStyle) {
      case "최신순":
        fetchData("/api/mypage/cakeDesign/latest", page, searchKeyword);
        break;
      case "조회수순":
        fetchData("/api/mypage/cakeDesign/views", page, searchKeyword);
        break;
      case "찜순":
        fetchData("/api/mypage/cakeDesign/likes", page, searchKeyword);
        break;
      default:
        fetchData("/api/mypage/cakeDesign", page, searchKeyword);
        break;
    }
  };
