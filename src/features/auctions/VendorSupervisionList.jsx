...
import AppealDesignDetails from "./VendorAppealDesignDetails"; // 생성한 Modal 컴포넌트 import

//import css
import "../../assets/css/vendor/supervisionList.css";
import VenderHeader from "../../components/vendor/VenderHeader";

const VendorSupervisionList = () => {
...
export default VendorSupervisionList;
