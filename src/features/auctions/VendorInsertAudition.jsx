...
//import 컴포넌트
import VendorProductModalInsert from '../products/VendorProductModalInsert';
import VenderAuditionRequest from './VendorAuditionRequest';

import VenderSidebar from '../../components/vendor/VenderSidebar';
import VenderHeader from '../../components/vendor/VenderHeader';
//import css
import '../../assets/css/vendor/vendorInsertAudition.css';

const VendorInsertAudition = () => {
    ...
    return (
        ...
        <div className="vender-container">
            ...
            <div className="vender-container">
                ...
                {/* 모달이 열려 있을 때만 VendorProductModalInsert 렌더링 */}
                {isModalOpen && (
                    <VendorProductModalInsert isOpen={isModalOpen} onClose={closeModal} productList={productList} onProductSelect={handleProductSelect} />
                )}
                {/* 모달이 열려 있을 때만 VendorProductModalInsert 렌더링 */}
...
export default VendorInsertAudition;
